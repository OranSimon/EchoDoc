...
EchoDoc is a unified Electron application designed for real-time meeting collaboration. It integrates both Host and Guest functionalities, enabling offline discovery, file broadcasting, and AI-powered note-taking.
